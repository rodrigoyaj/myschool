...
public class CsvHttpMessageConverter implements HttpMessageConverter<DiscountRO> {
    ...
    public List<MediaType> getSupportedMediaTypes() {
        return Arrays.asList(new MediaType("text", "customcsv", StandardCharsets.UTF_8));
    }
